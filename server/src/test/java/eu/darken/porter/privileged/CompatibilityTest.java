...
public class CompatibilityTest {
    ...
    @Before public void setup() {
        ...
        packages.when(() -> Android17Compat.getPackageInfo(eq(PorterServer.MANAGER_APPLICATION_ID), anyLong(), eq(0))).thenReturn(manager);
    ...
    @Test public void matchingCurrentCertificatesAndOwnedDangerousPermissionAreTrusted() {
        ...
        packages.verify(() -> Android17Compat.getPackageInfo(PorterServer.MANAGER_APPLICATION_ID,
    ...
    @Test public void missingManagerFailsClosed() {
        packages.when(() -> Android17Compat.getPackageInfo(eq(PorterServer.MANAGER_APPLICATION_ID), anyLong(), eq(0))).thenReturn(null);
        assertFalse(Compatibility.isAvailable());
    }
