...
final class ManagerTransactions {
    ...
    private static void enforceManagerPermission(PorterServer service, String func) {
        service.getCore().enforceManagerPermission(func, CallerIdentity.fromBinder());
    }

    static void compatibilitySetup(PorterServer service, Parcel data, Parcel reply) {
    ...
    static void globalAccess(PorterServer service, Parcel data, Parcel reply) {
    ...
    static void discoverApplications(PorterServer service, Parcel data, Parcel reply) {
        enforceManagerPermission(service, "discoverApplications");
        service.writeDiscovery(data.readInt(), reply);
    }

    static void getApplications(PorterServer service, Parcel data, Parcel reply) {
    ...
    static void setDebugLogging(PorterServer service, Parcel data, Parcel reply) {
    ...
    static void getDiagnostics(PorterServer service, Parcel data, Parcel reply) {
    ...
    static void userServiceLaunch(PorterServer service, Parcel data, Parcel reply) {
