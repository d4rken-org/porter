...
2. Follow the [installation and startup guide](/setup).
...
More help: [app compatibility](/compatibility) and [troubleshooting](/troubleshooting).
...
[Find the right setup for your apps](/compatibility).
...
Other app developers are welcome to support Porter's permission directly. [Add direct Porter support to your app](/developers).

## Need help?

Start with [troubleshooting](/troubleshooting), or [report a problem](https://github.com/d4rken-org/porter/issues).
