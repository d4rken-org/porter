...
Porter представляет собой минималистичный, поддерживаемый форк [Shizuku](https://github.com/RikkaApps/Shizuku), который предоставляет приложениям Android доступ через ADB с помощью API Shizuku. При желании можно использовать root.
