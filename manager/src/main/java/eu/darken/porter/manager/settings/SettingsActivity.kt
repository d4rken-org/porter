        ...
        when (dialog) {
            ...
            "tcp" -> {
                ...
                AlertDialog(onDismissRequest = dismiss, title = { Text(stringResource(R.string.settings_tcp_port)) }, text = {
                    ...
                    else { PorterSettings.setTcpPort(tcpText.toIntOrNull()); sendBroadcast(Intent(this@SettingsActivity, NotifCancelReceiver::class.java)); dismiss() }
            ...
            "restart" -> MessageDialog(stringResource(R.string.settings_restart_dialog_title), plainText(stringResource(R.string.settings_restart_dialog_message)), dismiss,
                onConfirm = { PorterSettings.setTcpPort(tcpText.toIntOrNull()); PorterReceiverStarter.start(this@SettingsActivity, true); dismiss() })
