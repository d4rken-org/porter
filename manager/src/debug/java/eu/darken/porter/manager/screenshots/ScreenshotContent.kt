...
import eu.darken.porter.manager.home.HomeActions
import eu.darken.porter.manager.home.HomeScreenContent
import eu.darken.porter.manager.home.HomeUiState
import eu.darken.porter.manager.home.ServiceStatusUi
import eu.darken.porter.manager.home.serviceStatusUi
import eu.darken.porter.manager.management.ApplicationManagementList
...
import eu.darken.porter.manager.settings.SettingsActions
import eu.darken.porter.manager.settings.SettingsScreenContent
import eu.darken.porter.manager.settings.SettingsUiState
...
private fun runningStatusUi(): ServiceStatusUi = serviceStatusUi(ServiceSnapshot(
    ...
    PorterStateMachine.State.RUNNING, installed = screenshotVersion,
))
